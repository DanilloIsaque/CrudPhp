...
<div class="logo">
<a href='../adm/menuAdm.php?id=<?php echo $_SESSION["id"] ?>'><img src="../imagens/logo5.png" width='100' height='60' ></a>
    </div>
...
<div class="container">
   <div class="row">
    ...
    <form action="estoqueAcesso/acessoEstoque.php" method="POST">
  ...
  <input type="text" class="form-control" maxlength=10 name="qtdEstoque" min="0"  aria-describedby="emailHelp" placeholder="Digite a quantidade"  required>
